...
import BuildingControl from '@/shared/footer-map/maplibregl/BuildingControl';
import LayerToggleControl from '@/shared/footer-map/maplibregl/LayerToggleControl';
