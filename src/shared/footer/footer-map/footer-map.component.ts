...
import BuildingControl from '@/shared/footer/footer-map/maplibregl/BuildingControl';
import LayerToggleControl from '@/shared/footer/footer-map/maplibregl/LayerToggleControl';
