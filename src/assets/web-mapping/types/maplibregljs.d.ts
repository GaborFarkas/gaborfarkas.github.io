...
type VariableAnchorOffsetCollectionSpecification = Array<string | [
	number,
	number
]>;
...
type CollatorExpressionSpecification = [
	"collator",
	{
...
type LayerSpecification = FillLayerSpecification | LineLayerSpecification | SymbolLayerSpecification | CircleLayerSpecification | HeatmapLayerSpecification | FillExtrusionLayerSpecification | RasterLayerSpecification | HillshadeLayerSpecification | BackgroundLayerSpecification;
/**
...
type Type = NullTypeT | NumberTypeT | StringTypeT | BooleanTypeT | ColorTypeT | ObjectTypeT | ValueTypeT | ArrayType | ErrorTypeT | CollatorTypeT | FormattedTypeT | PaddingTypeT | ResolvedImageTypeT | VariableAnchorOffsetCollectionTypeT;
...
type Value = null | string | boolean | number | Color | Collator | Formatted | Padding | ResolvedImage | VariableAnchorOffsetCollection | ReadonlyArray<Value> | {
...
declare class StyleExpression {
	...
	evaluateWithoutErrorHandling(globals: GlobalProperties, feature?: Feature$1, featureState?: FeatureState, canonical?: ICanonicalTileID, availableImages?: Array<string>, formattedSection?: FormattedSection): any;
	evaluate(globals: GlobalProperties, feature?: Feature$1, featureState?: FeatureState, canonical?: ICanonicalTileID, availableImages?: Array<string>, formattedSection?: FormattedSection): any;
}
...
type ConstantExpression = {
	kind: "constant";
	readonly evaluate: (globals: GlobalProperties, feature?: Feature$1, featureState?: FeatureState, canonical?: ICanonicalTileID, availableImages?: Array<string>) => any;
};
type SourceExpression = {
	kind: "source";
	isStateDependent: boolean;
	readonly evaluate: (globals: GlobalProperties, feature?: Feature$1, featureState?: FeatureState, canonical?: ICanonicalTileID, availableImages?: Array<string>, formattedSection?: FormattedSection) => any;
};
...
declare class StylePropertyFunction<T> {
	...
	kind: EvaluationKind;
	evaluate: (globals: GlobalProperties, feature?: Feature$1) => any;
	interpolationFactor: ((input: number, lower: number, upper: number) => number);
	zoomStops: Array<number>;
...
type FilterExpression = (globalProperties: GlobalProperties, feature: Feature$1, canonical?: ICanonicalTileID) => boolean;
type FeatureFilter = {
 ...
 */
declare const interpolateFactory: (interpolationType: "number" | "color" | "array" | "padding" | "variableAnchorOffsetCollection") => typeof array | typeof number | typeof color | typeof padding | typeof variableAnchorOffsetCollection;
 ...
 */
declare function validateStyleMin(style: StyleSpecification, styleSpec?: any): Array<ValidationError$1>;
...
type RingWithArea<T extends Point2D$1> = T[] & {
	area?: number;
};
/**
 ...
 */
declare function classifyRings<T extends Point2D$1>(rings: RingWithArea<T>[], maxRings?: number): RingWithArea<T>[][];
...
declare class Point$1 {
    ...
    clone(): Point$1;
    add(p: Point$1): Point$1;
    _add(p: Point$1): Point$1;
    sub(p: Point$1): Point$1;
    _sub(p: Point$1): Point$1;
    multiByPoint(p: Point$1): Point$1;
    divByPoint(p: Point$1): Point$1;
    mult(k: number): Point$1;
    _mult(k: number): Point$1;
    div(k: number): Point$1;
    _div(k: number): Point$1;
    rotate(k: number): Point$1;
    _rotate(k: number): Point$1;
    rotateAround(k: number, p: Point$1): Point$1;
    _rotateAround(k: number, p: Point$1): Point$1;
    matMult(m: number[]): Point$1;
    _matMult(m: number[]): Point$1;
    unit(): Point$1;
    _unit(): Point$1;
    perp(): Point$1;
    _perp(): Point$1;
    ...
    dist(p: Point$1): number;
    distSqr(p: Point$1): number;
    angle(): number;
    angleTo(b: Point$1): number;
    angleWith(b: Point$1): number;
    angleWithSep(x: number, y: number): number;

    static convert<T extends unknown>(a: T): T extends number[] ? Point$1 : T extends Point$1 ? Point$1 : T;
}
...
declare class PossiblyEvaluatedPropertyValue<T> {
	...
	evaluate(feature: Feature$1, featureState: FeatureState, canonical?: CanonicalTileID, availableImages?: Array<string>): T;
}
...
declare class DataDrivenProperty<T> implements Property<T, PossiblyEvaluatedPropertyValue<T>> {
	...
	evaluate(value: PossiblyEvaluatedValue<T>, parameters: EvaluationParameters, feature: Feature$1, featureState: FeatureState, canonical?: CanonicalTileID, availableImages?: Array<string>): T;
}
declare class CrossFadedDataDrivenProperty<T> extends DataDrivenProperty<CrossFaded<T>> {
	...
	evaluate(value: PossiblyEvaluatedValue<CrossFaded<T>>, globals: EvaluationParameters, feature: Feature$1, featureState: FeatureState, canonical?: CanonicalTileID, availableImages?: Array<string>): CrossFaded<T>;
...
declare class SourceCache extends Evented {
	 ...
	 */
	tilesIn(pointQueryGeometry: Array<Point$1>, maxPitchScaleFactor: number, has3DLayer: boolean): any[];
...
declare class SymbolStyleLayer extends StyleLayer {
	...
	getValueAndResolveTokens(name: any, feature: Feature$1, canonical: CanonicalTileID, availableImages: Array<string>): any;
...
declare class SymbolBucket implements Bucket {
	...
	_addCollisionDebugVertex(layoutVertexArray: StructArray, collisionVertexArray: StructArray, point: Point$1, anchorX: number, anchorY: number, extrude: Point$1): any;
...
declare class Transform {
	 ...
	 */
	locationPoint(lnglat: LngLat, terrain?: Terrain): Point$1;
	/**
	 ...
	 */
	pointLocation(p: Point$1, terrain?: Terrain): LngLat;
	/**
	 ...
	 * @returns lnglat
	 */
	pointCoordinate(p: Point$1, terrain?: Terrain): MercatorCoordinate;
	/**
	 ...
	 * @returns screen point
	 */
	coordinatePoint(coord: MercatorCoordinate, elevation?: number, pixelMatrix?: mat4): Point$1;
	/**
	 ...
	 *
	 */
	getCameraQueryGeometry(queryGeometry: Array<Point$1>): Array<Point$1>;
	/**
...
type QueryParameters = {
	...
	transform: Transform;
	tileSize: number;
	queryGeometry: Array<Point$1>;
	cameraQueryGeometry: Array<Point$1>;
	queryPadding: number;
	params: {
		filter: FilterSpecification;
		layers: Array<string>;
...
declare class FeatureIndex {
	...
	insert(feature: VectorTileFeature, geometry: Array<Array<Point$1>>, featureIndex: number, sourceLayerIndex: number, bucketIndex: number, is3D?: boolean): void;
	loadVTLayers(): {
		[_: string]: VectorTileLayer;
	};
...
declare class Tile {
	...
	queryRenderedFeatures(layers: {
		...
		[_: string]: any;
	}, sourceFeatureState: SourceFeatureState, queryGeometry: Array<Point$1>, cameraQueryGeometry: Array<Point$1>, scale: number, params: {
		filter: FilterSpecification;
		layers: Array<string>;
		availableImages: Array<string>;
...
declare class CircleBucket<Layer extends CircleStyleLayer | HeatmapStyleLayer> implements Bucket {
	...
	upload(context: Context): void;
	destroy(): void;
	addFeature(feature: BucketFeature, geometry: Array<Array<Point$1>>, index: number, canonical: CanonicalTileID): void;
}
...
declare class CircleStyleLayer extends StyleLayer {
	...
	queryIntersectsFeature(queryGeometry: Array<Point$1>, feature: VectorTileFeature, featureState: FeatureState, geometry: Array<Array<Point$1>>, zoom: number, transform: Transform, pixelsToTileUnits: number, pixelPosMatrix: mat4): boolean;
}
declare class FillBucket implements Bucket {
	...
	upload(context: Context): void;
	destroy(): void;
	addFeature(feature: BucketFeature, geometry: Array<Array<Point$1>>, index: number, canonical: CanonicalTileID, imagePositions: {
		[_: string]: ImagePosition;
	}): void;
}
...
declare class FillStyleLayer extends StyleLayer {
	...
	queryRadius(): number;
	queryIntersectsFeature(queryGeometry: Array<Point$1>, feature: VectorTileFeature, featureState: FeatureState, geometry: Array<Array<Point$1>>, zoom: number, transform: Transform, pixelsToTileUnits: number): boolean;
	isTileClipped(): boolean;
}
...
declare class FillExtrusionStyleLayer extends StyleLayer {
	...
	queryRadius(): number;
	is3D(): boolean;
	queryIntersectsFeature(queryGeometry: Array<Point$1>, feature: VectorTileFeature, featureState: FeatureState, geometry: Array<Array<Point$1>>, zoom: number, transform: Transform, pixelsToTileUnits: number, pixelPosMatrix: mat4): boolean | number;
}
...
declare class LineBucket implements Bucket {
	...
	addLine(vertices: Array<Point$1>, feature: BucketFeature, join: string, cap: string, miterLimit: number, roundLimit: number): void;
	/**
...
type TypedStyleLayer = CircleStyleLayer | FillStyleLayer | FillExtrusionStyleLayer | HeatmapStyleLayer | HillshadeStyleLayer | LineStyleLayer | SymbolStyleLayer;
type BinderUniform = {
	name: string;
	property: string;
	binding: Uniform<any>;
...
interface AttributeBinder {
	populatePaintArray(length: number, feature: Feature$1, imagePositions: {
		[_: string]: ImagePosition;
	}, canonical?: CanonicalTileID, formattedSection?: FormattedSection): void;
	updatePaintArray(start: number, length: number, feature: Feature$1, featureState: FeatureState, imagePositions: {
		[_: string]: ImagePosition;
	}): void;
...
declare class ProgramConfiguration {
	...
	populatePaintArrays(newLength: number, feature: Feature$1, imagePositions: {
		[_: string]: ImagePosition;
	}, canonical?: CanonicalTileID, formattedSection?: FormattedSection): void;
...
declare class ProgramConfigurationSet<Layer extends TypedStyleLayer> {
	...
	populatePaintArrays(length: number, feature: Feature$1, index: number, imagePositions: {
		[_: string]: ImagePosition;
	}, canonical: CanonicalTileID, formattedSection?: FormattedSection): void;
...
declare class CollisionIndex {
	...
	placeCollisionBox(collisionBox: SingleCollisionBox, overlapMode: OverlapMode, textPixelRatio: number, posMatrix: mat4, unwrappedTileID: UnwrappedTileID, pitchWithMap: boolean, rotateWithMap: boolean, translation: [
		number,
		number
	], collisionGroupPredicate?: (key: FeatureKey) => boolean, getElevation?: (x: number, y: number) => number, shift?: Point$1): PlacedBox;
	...
	projectPathToScreenSpace(projectedPath: Array<Point$1>, projectionContext: SymbolProjectionContext, labelToScreenMatrix: mat4): PointProjection[];
	/**
	 * Because the geometries in the CollisionIndex are an approximation of the shape of
	 * symbols on the map, we use the CollisionIndex to look up the symbol part of
	 * `queryRenderedFeatures`.
	 */
	queryRenderedSymbols(viewportQueryGeometry: Array<Point$1>): {};
...
declare class TouchPanHandler implements Handler {
	...
	touchstart(e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>): {
		around: Point$1;
		panDelta: Point$1;
	};
	touchmove(e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>): {
		around: Point$1;
		panDelta: Point$1;
	};
	touchend(e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>): void;
	touchcancel(): void;
	_calculateTransform(e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>): {
		around: Point$1;
		panDelta: Point$1;
	};
	enable(): void;
...
interface Handler {
	 ...
	 */
	reset(): void;
	readonly touchstart?: (e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>) => HandlerResult | void;
	readonly touchmove?: (e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>) => HandlerResult | void;
	readonly touchmoveWindow?: (e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>) => HandlerResult | void;
	readonly touchend?: (e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>) => HandlerResult | void;
	readonly touchcancel?: (e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>) => HandlerResult | void;
...
declare abstract class TwoFingersTouchHandler implements Handler {
	...
	abstract _move(points: [
		Point$1,
		Point$1
	], pinchAround: Point$1 | null, e: TouchEvent): HandlerResult | void;
	touchstart(e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>): void;
	touchmove(e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>): HandlerResult | void;
	touchend(e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>): void;
	touchcancel(): void;
	/**
...
declare class TwoFingersTouchZoomHandler extends TwoFingersTouchHandler {
	...
	_move(points: [
		Point$1,
		Point$1
	], pinchAround: Point$1 | null): HandlerResult | void;
}
/**
...
declare class TwoFingersTouchRotateHandler extends TwoFingersTouchHandler {
	...
	_move(points: [
		Point$1,
		Point$1
	], pinchAround: Point$1 | null, _e: TouchEvent): HandlerResult | void;
...
declare class TwoFingersTouchPitchHandler extends TwoFingersTouchHandler {
	...
	_move(points: [
		Point$1,
		Point$1
	], center: Point$1 | null, e: TouchEvent): HandlerResult | void;
...
declare class SingleTapRecognizer {
	...
	reset(): void;
	touchstart(e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>): void;
	touchmove(e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>): void;
	touchend(e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>): Point$1;
}
...
declare class TapZoomHandler implements Handler {
	...
	touchstart(e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>): void;
	touchmove(e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>): void;
	touchend(e: TouchEvent, points: Array<Point$1>, mapTouches: Array<Touch>): {
...
interface OneFingerTouchRotateHandler extends DragMoveHandler<DragRotateResult, TouchEvent> {
}
interface OneFingerTouchPitchHandler extends DragMoveHandler<DragPitchResult, TouchEvent> {
}
/**
...
declare class MouseRotateWrapper {
	...
	startMouse(e: MouseEvent, point: Point$1): void;
	startTouch(e: TouchEvent, point: Point$1): void;
	moveMouse(e: MouseEvent, point: Point$1): void;
	moveTouch(e: TouchEvent, point: Point$1): void;
	off(): void;
	offTemp(): void;
...
export { type $ObjMap, AJAXError, type ActorMessage, type ActorTarget, type AddLayerObject, type AddProtocolAction, type Alignment, type AnimationOptions, type AroundCenterOptions, type ArrayType, type AttributeBinder, AttributionControl, type AttributionControlOptions, type BackgroundLayerSpecification, type BinderUniform, type BlendEquationType, type BlendFuncConstant, type BlendFuncType, type BooleanTypeT, BoxZoomHandler, type Bucket, type BucketFeature, type BucketParameters, type BucketPart, type CameraExpression, type CameraForBoundsOptions, type CameraFunctionSpecification, type CameraOptions, type CameraUpdateTransformFunction, CanvasSource, type CanvasSourceSpecification, type CenterZoomBearing, type CircleLayerSpecification, type CircleLayoutProps, type CircleLayoutPropsPossiblyEvaluated, type CirclePaintProps, type CirclePaintPropsPossiblyEvaluated, type ClearArgs, type ClusterIDAndSource, type CollatorExpressionSpecification, type CollatorOptions, type CollatorTypeT, type CollisionArrays, type CollisionGroup, Color, type ColorMaskType, type ColorSpecification, ColorType, type ColorTypeT, type CompareFuncType, type Complete, type CompleteMapOptions, type CompositeExpression, type CompositeFunctionSpecification, CompoundExpression, type Config, type ConstantExpression, type ControlPosition, CooperativeGesturesHandler, type Coordinates, type CrossFaded, type CrossTileID, type CrossfadeParameters, type CullFaceModeType, type CustomLayerInterface, type CustomRenderMethod, type CustomRenderMethodInput, type DEMEncoding, type DashEntry, type DataDrivenPropertyValueSpecification, type DataTextureImage, type Definition, type Delegate, type DelegatedListener, type DepthFuncType, type DepthMaskType, type DepthRangeType, type DiffCommand, type DiffOperations, type DiffOperationsMap, type DistributiveKeys, type DistributiveOmit, DoubleClickZoomHandler, type DragMoveHandler, type DragMovementResult, DragPanHandler, type DragPanOptions, type DragPanResult, type DragPitchResult, DragRotateHandler, type DragRotateHandlerOptions, type DragRotateResult, type DrawMode, type EaseToOptions, EdgeInsets, type EmptyImage, type Entry, type ErrorTypeT, type Evaluate, EvaluationContext, type EvaluationKind, type EventInProgress, Evented, type EventsInProgress, type ExpectedTypes, type ExpiryData, type Expression, type ExpressionFilterSpecification, type ExpressionInputType, type ExpressionParameters, type ExpressionParser, type ExpressionRegistration, type ExpressionRegistry, type ExpressionSpecification, type ExpressionSpecificationDefinition, type ExpressionType, type Feature$1 as Feature, type FeatureFilter, type FeatureIdentifier, type FeatureKey, type FeaturePosition, type FeatureState, type FeatureStates, type FillExtrusionLayerSpecification, type FillExtrusionPaintProps, type FillExtrusionPaintPropsPossiblyEvaluated, type FillLayerSpecification, type FillLayoutProps, type FillLayoutPropsPossiblyEvaluated, type FillPaintProps, type FillPaintPropsPossiblyEvaluated, type FilterExpression, type FilterSpecification, type FitBoundsOptions, type FlyToOptions, FormatExpression, Formatted, FormattedSection, type FormattedSectionExpression, type FormattedSpecification, FormattedType, type FormattedTypeT, type FrontFaceType, FullscreenControl, type FullscreenControlOptions, type GeoJSONFeatureDiff, type GeoJSONFeatureId, GeoJSONSource, type GeoJSONSourceDiff, type GeoJSONSourceInternalOptions, type GeoJSONSourceOptions, type GeoJSONSourceSpecification, type GeoJSONWorkerOptions, type GeoJSONWorkerSourceLoadDataResult, GeolocateControl, type GeolocateControlOptions, type GestureOptions, type GetClusterLeavesParams, type GetGlyphsParameters, type GetGlyphsResponse, type GetImagesParameters, type GetImagesResponse, type GetResourceResponse, type GlobalProperties, type GlyphMetrics, type GlyphPosition, type GlyphPositions, type GradientTexture, type GridKey, type HCLColor, type Handler, type HandlerResult, Hash, type HeatmapLayerSpecification, type HeatmapPaintProps, type HeatmapPaintPropsPossiblyEvaluated, type HillshadeLayerSpecification, type HillshadePaintProps, type HillshadePaintPropsPossiblyEvaluated, type IActor, type ICanonicalTileID, type IControl, type ILngLat, type ILngLatLike, type IMercatorCoordinate, type IValue, ImageSource, type ImageSourceSpecification, type IndexToPointCache, type IndexedFeature, Interpolate, type InterpolatedValueType, type InterpolationColorSpace, type InterpolationSpecification, type InterpolationType, type JumpToOptions, KeyboardHandler, type LABColor, type LayerFeatureStates, type LayerSpecification, type LegacyFilterSpecification, type LightPosition, type LightProps, type LightPropsPossiblyEvaluated, type LightSpecification, type LineClips, type LineLayerSpecification, type LineLayoutProps, type LineLayoutPropsPossiblyEvaluated, type LinePaintProps, type LinePaintPropsPossiblyEvaluated, type Listener, type Listeners, Literal, LngLat, LngLatBounds, type LngLatBoundsLike, type LngLatLike, type LoadGeoJSONParameters, LogoControl, type LogoControlOptions, Map$1 as Map, type MapContextEvent, type MapDataEvent, type MapEventType, type MapGeoJSONFeature, type MapLayerEventType, type MapLayerMouseEvent, type MapLayerTouchEvent, type MapLibreEvent, type MapLibreZoomEvent, MapMouseEvent, type MapOptions, type MapSourceDataEvent, type MapSourceDataType, type MapStyleDataEvent, type MapStyleImageMissingEvent, type MapTerrainEvent, MapTouchEvent, MapWheelEvent, Marker, type MarkerOptions, MercatorCoordinate, type MessageData, type MessageHandler, MessageType, type MousePanHandler, type MousePitchHandler, type MouseRotateHandler, NavigationControl, type NavigationControlOptions, NullType, type NullTypeT, type NumberTypeT, type ObjectTypeT, type Offset, type OneFingerTouchPitchHandler, type OneFingerTouchRotateHandler, type OverlapMode, Padding, type PaddingOptions, type PaddingSpecification, type PaddingTypeT, type PainterOptions, ParsingError, type Pattern, type PlacedBox, type PlacedCircles, type PluginState, Point$1 as Point, type Point2D, type PointLike, type PointProjection, type PoolObject, type PopulateParameters, Popup, type PopupOptions, type PositionAnchor, type PossiblyEvaluatedValue, type Projection, type ProjectionCache, type ProjectionSpecification, type PromoteIdSpecification, type Property, type PropertyCallback, type PropertyValueSpecification, type QueryParameters, type QueryRenderedFeaturesOptions, type QueryResult, type QuerySourceFeatureOptions, type RGBColor, type RTLPluginStatus, type RasterDEMSourceSpecification, RasterDEMTileSource, type RasterLayerSpecification, type RasterSourceSpecification, RasterTileSource, type Rect, type RemoveSourceParams, type RenderPass, type RequestParameters, type RequestResponseMessageMap, type RequestTransformFunction, type RequireAtLeastOne, type ResolveReject, ResolvedImage, type ResolvedImageOptions, type ResolvedImageSpecification, type ResolvedImageTypeT, ResourceType, type Result, type RingWithArea, ScaleControl, type ScaleControlOptions, ScrollZoomHandler, type Segment, type Serialized, type SerializedFeaturePositionMap, type SerializedGrid, type SerializedObject, type SerializedStructArray, type SetClusterOptions, type Signature, type SingleCollisionBox, type Size, type SizeData, type SkyProps, type SkyPropsPossiblyEvaluated, type SkySpecification, type SortKeyRange, type Source, type SourceClass, type SourceExpression, type SourceFunctionSpecification, type SourceSpecification, type SpriteOnDemandStyleImage, type SpriteSpecification, type StencilFuncType, type StencilOpConstant, type StencilOpType, type StencilTestGL, Step, type Stops, type StringTypeT, type StructArrayMember, Style, StyleExpression, type StyleGlyph, type StyleImage, type StyleImageData, type StyleImageInterface, type StyleImageMetadata, type StyleOptions, type StylePropertyExpression, StylePropertyFunction, type StylePropertySpecification, type StyleSetterOptions, type StyleSpecification, type StyleSwapOptions, type Subscription, type SymbolFeature, type SymbolInstance, type SymbolLayerSpecification, type SymbolLayoutProps, type SymbolLayoutPropsPossiblyEvaluated, type SymbolPaintProps, type SymbolPaintPropsPossiblyEvaluated, type SymbolProjectionContext, type SymbolQuad, type SymbolsByKeyEntry, type Task, type TaskID, TerrainControl, type TerrainData, type TerrainPreludeUniformsType, type TerrainSpecification, type TextAnchor, type TextAnchorOffset, TextFit, type TextureFilter, type TextureFormat, type TextureImage, type TextureUnitType, type TextureWrap, type TileLayerParameters, type TileParameters, type TileState, type TimePoint, type TransformStyleFunction, type TransitionParameters, type TransitionSpecification, TwoFingersTouchPitchHandler, TwoFingersTouchRotateHandler, TwoFingersTouchZoomHandler, TwoFingersTouchZoomRotateHandler, type Type, type TypedStyleLayer, type UniformBinder, type UniformBindings, type UniformLocations, type UniformValues, type Unit, type UpdateImageOptions, type UpdateLayersParamaeters, type ValidationError, type Validator, type Value, type ValueTypeT, type Varargs, VariableAnchorOffsetCollection, type VariableAnchorOffsetCollectionSpecification, type VariableAnchorOffsetCollectionTypeT, type VariableOffset, type VectorSourceSpecification, VectorTileSource, type VectorTileSourceOptions, VideoSource, type VideoSourceSpecification, type ViewType, type ViewportType, type WorkerDEMTileParameters, type WorkerTileParameters, type WorkerTileResult, ZoomConstantExpression, ZoomDependentExpression, addProtocol, addSourceType, classifyRings, clearPrewarmedResources, config, convertFilter, convertFunction, createExpression, createFunction, createPropertyExpression, derefLayers, diffStyles as diff, emptyStyle, expression, expressions, createFilter as featureFilter, format, styleFunction as function, getMaxParallelImageRequests, getRTLTextPluginStatus, getVersion, getWorkerCount, getWorkerUrl, groupByLayout, importScriptInWorkers, interpolateFactory, interpolate as interpolates, isExpression, isFunction, isZoomExpression, _default as latest, migrate, normalizePropertyExpression, prewarm, removeProtocol, setMaxParallelImageRequests, setRTLTextPlugin, setWorkerCount, setWorkerUrl, supportsPropertyExpression, toString$1 as toString, typeOf, v8, validate, validateStyleMin, visit };
}
