...
declare class Control extends Class {
...
export { type BaseIconOptions, Bounds, type BoundsExpression, type BoundsLiteral, Browser, CRS, Canvas, Circle, CircleMarker, type CircleMarkerOptions, type CircleOptions, Class, type Content, Control, type ControlOptions, type ControlPosition, type Coords, type CrossOrigin, type DefaultMapPanes, type Direction, DivIcon, type DivIconOptions, DivOverlay, type DivOverlayOptions, DomEvent, DomUtil, type DoneCallback, type DragEndEvent, type DragEndEventHandlerFn, Draggable, type DraggableOptions, type ErrorEvent, type ErrorEventHandlerFn, Evented, FeatureGroup, type FillRule, type FitBoundsOptions, GeoJSON, type GeoJSONEvent, type GeoJSONOptions, GridLayer, type GridLayerOptions, Handler, Icon, type IconOptions, ImageOverlay, type ImageOverlayOptions, type ImageOverlayStyleOptions, type InteractiveLayerOptions, type InternalTiles, type InvalidateSizeOptions, LatLng, LatLngBounds, type LatLngBoundsExpression, type LatLngBoundsLiteral, type LatLngExpression, type LatLngLiteral, type LatLngTuple, Layer, type LayerEvent, type LayerEventHandlerFn, LayerGroup, type LayerOptions, type LayersControlEvent, type LayersControlEventHandlerFn, type LeafletEvent, type LeafletEventHandlerFn, type LeafletEventHandlerFnMap, type LeafletKeyboardEvent, type LeafletKeyboardEventHandlerFn, type LeafletMouseEvent, type LeafletMouseEventHandlerFn, type LineCapShape, type LineJoinShape, LineUtil, type LocateOptions, type LocationEvent, type LocationEventHandlerFn, Map, type MapOptions, Marker, type MarkerOptions, Mixin, type PanInsideOptions, type PanOptions, Path, type PathOptions, Point, type PointExpression, type PointTuple, PolyUtil, Polygon, Polyline, type PolylineOptions, Popup, type PopupEvent, type PopupEventHandlerFn, type PopupOptions, PosAnimation, Projection, Rectangle, type ReferrerPolicy, Renderer, type RendererOptions, type ResizeEvent, type ResizeEventHandlerFn, SVG, SVGOverlay, type SVGOverlayStyleOptions, type StyleFunction, type TileErrorEvent, type TileErrorEventHandlerFn, type TileEvent, type TileEventHandlerFn, TileLayer, type TileLayerOptions, Tooltip, type TooltipEvent, type TooltipEventHandlerFn, type TooltipOptions, Transformation, Util, VideoOverlay, type VideoOverlayOptions, type WMSOptions, type WMSParams, Zoom, type ZoomAnimEvent, type ZoomAnimEventHandlerFn, type ZoomOptions, type ZoomPanOptions, bind, bounds, canvas, circle, circleMarker, control, divIcon, extend, featureGroup, geoJSON, geoJson, gridLayer, icon, imageOverlay, latLng, latLngBounds, layerGroup, map, marker, noConflict, point, polygon, polyline, popup, rectangle, setOptions, stamp, svg, svgOverlay, tileLayer, tooltip, transformation, version, videoOverlay };
}
