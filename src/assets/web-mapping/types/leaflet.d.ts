    ...
    export namespace CRS {
        ...
        namespace EPSG3395 {
            ...
            namespace projection {
                ...
                namespace bounds {
                    // Too-deep object hierarchy from leaflet.CRS.EPSG3395.projection.bounds
                    const contains: any;
        ...
        namespace EPSG3857 {
            ...
            namespace projection {
                ...
                namespace bounds {
                    // Too-deep object hierarchy from leaflet.CRS.EPSG3857.projection.bounds
                    const contains: any;
        ...
        namespace EPSG4326 {
            ...
            namespace projection {
                ...
                namespace bounds {
                    // Too-deep object hierarchy from leaflet.CRS.EPSG4326.projection.bounds
                    const contains: any;
        ...
        namespace EPSG900913 {
            ...
            namespace projection {
                ...
                namespace bounds {
                    // Too-deep object hierarchy from leaflet.CRS.EPSG900913.projection.bounds
                    const contains: any;
        ...
        namespace Simple {
            ...
            namespace projection {
                ...
                namespace bounds {
                    // Too-deep object hierarchy from leaflet.CRS.Simple.projection.bounds
                    const contains: any;
