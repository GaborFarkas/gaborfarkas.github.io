...
ol.control.Projection.prototype.addProjection = function (projection, opt_name) {
    ...
    newProjOption.textContent = opt_name || projection.getCode();
...
function init() {
    ...
    projControl.addProjection(polarProj, 'Arctic Polar Stereo');
    proj4.defs('ESRI:54009', '+proj=moll +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs');
    var mollweide = new ol.proj.Projection({
        code: 'ESRI:54009',
        extent: [-18e6, -9e6, 18e6, 9e6],
        worldExtent: [-180, 90, 180, 90]
    });
    projControl.addProjection(mollweide, 'World Mollweide');
    ...
    projControl.addProjection(eov, 'HD72/EOV');
